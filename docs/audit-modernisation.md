...
| `npm test --workspace @acp/pixel-office-engine` | 12 fichiers, 117 tests réussis dans le worktree combiné ; 7 fichiers et 74 tests appartiennent à la branche Lot A |
...
**74 tests du moteur legacy** réussis ; typecheck TypeScript et build Vite réussis.
...
Après migration vers Vite `8.3.0` et Vitest `5.0.0`, `npm ci` puis `npm audit`
signalent **0 vulnérabilité connue** dans le lockfile de la branche.
