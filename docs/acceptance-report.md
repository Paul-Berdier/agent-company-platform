...
tag `v0.8.0`) après CI verte observée. Le Lot H `0.9.0` a été publié depuis (PR #8,
tag `v0.9.0`) ; ce rapport n'a pas encore été réévalué sur 0.9.0.
